...
Kling IMAGE 3.0 Omni is a large image model, so a towering, two-handed painterly weapon fits its high-capacity visual generation—an oversized War Banner-Brush that the Echo-Howler Warg can clamp in its jaws or brace in its forelimbs like a carried standard. Voidsteel signals large-model power in a retro dark-fantasy palette: dense, night-metal sheen that reads as ominous, high-tier gear.
...
model name: Kling IMAGE 3.0 Omni
...
https://modeldrop.shard.media/models/avatars/raw/kling-ai.kling-image-3.0-omni.png
...
Voidsteel Echo-Howler Warg holding War Banner-Brush

### avatar url

https://modeldrop.shard.media/models/avatars/kling-ai.kling-image-3.0-omni.png
...
Echo-Howler Warg holding War Banner-Brush from image 1
