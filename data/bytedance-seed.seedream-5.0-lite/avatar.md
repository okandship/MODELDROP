...
Seedream 5.0 Lite is a small image model, so a light, precise weapon suits its fast visual sketching role; a Spriggan Code-Dancer can comfortably wield a dagger while weaving spells. Bioluminescent Moss adds small-scale yet potent, pixel-fantasy energy to match a spriggan’s forest-born, arcane aesthetic.
...
https://modeldrop.shard.media/models/avatars/raw/bytedance-seed.seedream-5.0-lite.png
...
Bioluminescent Moss Spriggan Code-Dancer holding Glyph-Engraved Dagger

### avatar url

https://modeldrop.shard.media/models/avatars/bytedance-seed.seedream-5.0-lite.png
...
Spriggan Code-Dancer holding Glyph-Engraved Dagger from image 1
