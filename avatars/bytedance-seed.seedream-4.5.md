...
Gear-Toothed Longsword of Stitched Sprites

### material

Verdigris Brass with Emerald Sap-Glow Filigree

### reasoning

Seedream 4.5 (image) suggests sprite-crafting and visual stitching; a medium model fits a longsword-tier weapon rather than a dagger or colossal relic. The Sproutmancer Clockwork Imp can wield a single longsword sized to an imp, and the gear teeth echo its clockwork nature. Verdigris brass conveys mid-tier, well-used power, while emerald sap-glow filigree nods to sproutmagic and the ‘dream-seed’ vibe of Seedream.

### monster

Sproutmancer Clockwork Imp
...
monster: Sproutmancer Clockwork Imp