...
Z-Image (image modality) suits a medium weapon-like tool for crafting visuals, so a rune-etched longsword reads as a precise yet powerful image-forging blade. A Jade Archive Wyrm can coil and grip a long weapon in its claws, and the archive theme matches runes and etched glyphs. Medium size maps to a durable, luminous power texture—Starforged Jade—echoing the wyrm’s jade body and hoarded knowledge.
...
https://modeldrop.shard.media/models/avatars/raw/tongyi.z-image.png
...
Starforged Jade Jade Archive Wyrm holding Rune-etched Longsword

### avatar url

https://modeldrop.shard.media/models/avatars/tongyi.z-image.png
...
Jade Archive Wyrm holding Rune-etched Longsword from image 1
