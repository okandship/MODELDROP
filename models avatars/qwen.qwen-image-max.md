...
Colossal Calligrapher's Greatsword
...
Qwen Image Max is a large image model, so it maps to an oversized image-crafting weapon; a Desert Djinn Scribe can wield a two-handed calligrapher’s greatsword that 'paints' reality with sweeping strokes. Starforged Brass conveys high-tier power with a retro dark-fantasy desert-metal sheen that suits a djinn relic.
...
https://modeldrop.shard.media/models/avatars/raw/qwen.qwen-image-max.png
...
Starforged Brass Desert Djinn Scribe holding Colossal Calligrapher's Greatsword

### avatar url

https://modeldrop.shard.media/models/avatars/qwen.qwen-image-max.png
...
Desert Djinn Scribe holding Colossal Calligrapher's Greatsword from image 1
