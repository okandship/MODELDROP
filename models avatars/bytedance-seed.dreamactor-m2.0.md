...
DreamActor M2.0 is a medium video model, so a carryable vision/time tool fits best: a lantern that 'projects' animated shadows like staged scenes. The Spriggan Code-Dancer can wield it one-handed while moving, and rune etchings nod to coded choreography. Moonlit obsidian conveys medium-tier power in a retro dark-fantasy palette, with a sleek, reflective texture suited to dreamlike video illusions.
...
https://modeldrop.shard.media/models/avatars/raw/bytedance-seed.dreamactor-m2.0.png
...
Moonlit obsidian Spriggan Code-Dancer holding Rune-etched lantern

### avatar url

https://modeldrop.shard.media/models/avatars/bytedance-seed.dreamactor-m2.0.png
...
Spriggan Code-Dancer holding Rune-etched lantern from image 1
