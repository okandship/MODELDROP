...
DreamActor v2 is a medium video model, so a vision/time-focused tool fits: a hand mirror evokes framed moving scenes and performance playback. The Spriggan Code-Dancer can wield it one-handed like a nimble stage prop, matching a dancer’s flair. Voidsteel signals medium-tier arcane power with a retro dark-fantasy, pixel-RPG edge suited to DreamActor’s dreamlike cinematics.
...
https://modeldrop.shard.media/models/avatars/raw/bytedance-seed.dreamactor-v2.png
...
Voidsteel Spriggan Code-Dancer holding Runed Hand Mirror

### avatar url

https://modeldrop.shard.media/models/avatars/bytedance-seed.dreamactor-v2.png
...
Spriggan Code-Dancer holding Runed Hand Mirror from image 1
