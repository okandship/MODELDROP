...
Qwen Image 2.0 is a medium image model, so a mid-tier paint-as-weapon fits: a longbrush sized for a Desert Djinn Scribe doubles as a spear-like implement for drafting and striking, matching the retro pixel-art dark fantasy vibe. Glassfire evokes desert heat and higher power without being the item itself—an energetic texture that can shimmer across the djinn’s gear and effects.
...
Glassfire Desert Djinn Scribe holding Runed Longbrush Spear
...
Desert Djinn Scribe holding Runed Longbrush Spear from image 1
