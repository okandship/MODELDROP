...
PixVerse v5.6 suggests a pixel-born, reality-bending video engine; a medium video model maps to a handheld time/vision tool, so a Chrono-Lantern fits—casting frames like light through time. The Glitch Fey (Pixel Sprite Archon) can wield it one-handed as an enchanted relic. Glitchsteel conveys medium-tier potency with a retro digital-corrupted metal sheen.
...
Glitchsteel Glitch Fey (Pixel Sprite Archon) holding Chrono-Lantern
...
Glitch Fey (Pixel Sprite Archon) holding Chrono-Lantern from image 1
