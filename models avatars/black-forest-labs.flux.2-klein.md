...
FLUX.2 \[klein] is a small image model, so a precise, hand-held tool fits best—an occult dagger that etches runes like drawing pixels into form. The Wyrdwood Witch-Hart can wield it as a ritual implement while stalking the forest. Ebon sap conveys compact but potent magic, a dark fantasy texture that signals ‘small yet strong’ power.
...
https://modeldrop.shard.media/models/avatars/raw/black-forest-labs.flux.2-klein.png
...
Ebon sap Wyrdwood Witch-Hart holding Rune-Carving Dagger

### avatar url

https://modeldrop.shard.media/models/avatars/black-forest-labs.flux.2-klein.png
...
Wyrdwood Witch-Hart holding Rune-Carving Dagger from image 1
