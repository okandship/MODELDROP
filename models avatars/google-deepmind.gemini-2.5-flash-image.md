...
Nano Banana suggests weird, meme-arcane flair; a medium image model maps to a main-hand weapon used to 'etch' visions—so an Elder Brain Overmind wields a psionic runeblade like a focused thought-cutter. Abyssal Ivory signals medium-tier but potent, otherworldly power suited to an overmind’s dark fantasy presence.

### monster

Elder Brain Overmind
...
monster: Elder Brain Overmind

### avatar raw url

https://modeldrop.shard.media/models/avatars/raw/google-deepmind.gemini-2.5-flash-image.png
...
Abyssal Ivory Elder Brain Overmind holding Psionic Runeblade

### avatar url

https://modeldrop.shard.media/models/avatars/google-deepmind.gemini-2.5-flash-image.png
...
Elder Brain Overmind holding Psionic Runeblade from image 1

dominant colors: Abyssal Indigo, Psychic Neon Cyan
