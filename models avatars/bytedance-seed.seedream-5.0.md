...
Seedream 5.0 (image) suggests precise visual ‘carving’ into reality; a medium model maps well to a balanced, one- or two-handed longsword. The Spriggan Code-Dancer can wield a nimble blade while moving, and rune-etching evokes algorithmic image synthesis. Moonlit obsidian signals mid-tier arcane power in a retro dark-fantasy pixel RPG tone without being tied to the weapon itself.

### monster

Spriggan Code-Dancer

### model id

bytedance-seed.seedream-5.0
...
monster: Spriggan Code-Dancer

### avatar raw url

https://modeldrop.shard.media/models/avatars/raw/bytedance-seed.seedream-5.0.png
...
Moonlit obsidian Spriggan Code-Dancer holding Rune-etched longsword

### avatar url

https://modeldrop.shard.media/models/avatars/bytedance-seed.seedream-5.0.png
...
Spriggan Code-Dancer holding Rune-etched longsword from image 1

dominant colors: Neon Jade, Midnight Violet
