...
Hunyuan 3D 3.1 is a medium 3D model, so a construction/sculpting tool fits best—an artisan hammer suggests shaping forms into solid geometry. The Jade Thunder Wyrm can coil and grip a hefty handled tool, and the runic forging vibe matches retro dark-fantasy pixel RPG aesthetics. Stormglass signals medium-tier power with electrified clarity, echoing the wyrm’s thunder nature without being the item itself.
...
model name: Hunyuan 3D 3.1

model size: medium

model modality: 3d

monster: Jade Thunder Wyrm

### avatar raw url

https://modeldrop.shard.media/models/avatars/raw/tencent-hy.hunyuan-3d-3.1.png
...
Stormglass Jade Thunder Wyrm holding Runesmith’s Sculptor Hammer

### avatar url

https://modeldrop.shard.media/models/avatars/tencent-hy.hunyuan-3d-3.1.png
...
Jade Thunder Wyrm holding Runesmith’s Sculptor Hammer from image 1
