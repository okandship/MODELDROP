...
Kling Omni 3 is a large video model, so the Echo-Howler Warg bears a massive vision-focused relic: a towering reflective shield that can ‘catch’ and replay motion like captured scenes. Voidsteel signals large-scale power—dark, dense, and arcane—matching the retro dark-fantasy pixel RPG tone and the warg’s echoing, predatory aura.
...
https://modeldrop.shard.media/models/avatars/raw/kling-ai.kling-omni-3.png
...
Voidsteel Echo-Howler Warg holding Moonlit Tower Shield

### avatar url

https://modeldrop.shard.media/models/avatars/kling-ai.kling-omni-3.png
...
Echo-Howler Warg holding Moonlit Tower Shield from image 1
